package com.emsi.scskafka.web;

import com.emsi.scskafka.entities.PageEvent;
...
public class PageEventRestController {
    ...
    public PageEvent publish(@PathVariable String topic, @PathVariable String name) {
        PageEvent pageEvent = new PageEvent(name, Math.random() > 0.5 ? "user1" : "user2", new Date(), (long) (Math.random() * 10000));
